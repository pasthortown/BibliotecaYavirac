...
import { Message, RecurseVisitor } from '@angular/compiler/src/i18n/i18n_ast';
...
@Component({
   ...
   styleUrls: ['./comentariossugerencias.component.scss']
})

export class ComentariosSugerenciasComponent implements OnInit {

   busy: Promise<any>;
   entidades: ComentariosSugerencias[];
   entidadSeleccionada: ComentariosSugerencias;
   pagina: 1;
   tamanoPagina: 20;
   paginaActual: number;
   paginaUltima: number;
   ...
   isValid(entidadPorEvaluar: ComentariosSugerencias): boolean {
      return true;
   }
   ...
   crearEntidad(): ComentariosSugerencias {
      const nuevoComentariosSugerencias = new ComentariosSugerencias();
      nuevoComentariosSugerencias.id = 0;
      return nuevoComentariosSugerencias;
   }

   add(entidadNueva: ComentariosSugerencias): void {
   ...
   update(entidadParaActualizar: ComentariosSugerencias): void {
   ...
   delete(entidadParaBorrar: ComentariosSugerencias): void {

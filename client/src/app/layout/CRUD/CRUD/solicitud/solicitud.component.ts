...
export class SolicitudComponent implements OnInit {
   ...
   isValid(entidadPorEvaluar: Solicitud): boolean {
      return true;
   }
   ...
   crearEntidad(): Solicitud {
      const nuevoSolicitud = new Solicitud();
      nuevoSolicitud.id = 0;
      return nuevoSolicitud;
   }

   add(entidadNueva: Solicitud): void {
   ...
   update(entidadParaActualizar: Solicitud): void {
   ...
   delete(entidadParaBorrar: Solicitud): void {

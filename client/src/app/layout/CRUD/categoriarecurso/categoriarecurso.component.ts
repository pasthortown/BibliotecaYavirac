...
@Component({
   selector: 'app-categoriarecurso',
   templateUrl: './categoriarecurso.component.html',
   styleUrls: ['./categoriarecurso.component.scss']
})

export class CategoriaRecursoComponent implements OnInit {

   busy: Promise<any>;
   entidades: CategoriaRecurso[];
   entidadSeleccionada: CategoriaRecurso;
   pagina: 1;
   tamanoPagina: 20;
   paginaActual: number;
   paginaUltima: number;
   ...
   isValid(entidadPorEvaluar: CategoriaRecurso): boolean {
      return true;
   }
   ...
   crearEntidad(): CategoriaRecurso {
      const nuevoCategoriaRecurso = new CategoriaRecurso();
      nuevoCategoriaRecurso.id = 0;
      return nuevoCategoriaRecurso;
   }

   add(entidadNueva: CategoriaRecurso): void {
   ...
   update(entidadParaActualizar: CategoriaRecurso): void {
   ...
   delete(entidadParaBorrar: CategoriaRecurso): void {

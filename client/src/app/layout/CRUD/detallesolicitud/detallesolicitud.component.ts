...
export class DetalleSolicitudComponent implements OnInit {
   ...
   busy: Promise<any>;
   entidades: DetalleSolicitud[];
   entidadSeleccionada: DetalleSolicitud;
   pagina: 1;
   tamanoPagina: 20;
   paginaActual: number;
   paginaUltima: number;
   ...
   isValid(entidadPorEvaluar: DetalleSolicitud): boolean {
      return true;
   }
   ...
   crearEntidad(): DetalleSolicitud {
      const nuevoDetalleSolicitud = new DetalleSolicitud();
      nuevoDetalleSolicitud.id = 0;
      return nuevoDetalleSolicitud;
   }

   add(entidadNueva: DetalleSolicitud): void {
   ...
   update(entidadParaActualizar: DetalleSolicitud): void {
   ...
   delete(entidadParaBorrar: DetalleSolicitud): void {

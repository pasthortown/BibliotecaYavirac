...
export class AutorComponent implements OnInit {
   ...
   constructor(public toastr: ToastsManager, vcr: ViewContainerRef, private dataService: AutorService, private modalService: NgbModal) {
   ...
   isValid(entidadPorEvaluar: Autor): boolean {
      return true;
   }
   ...
   update(entidadParaActualizar: Autor): void {
   ...
   delete(entidadParaBorrar: Autor): void {
   ...
   onSelect(entidadActual: Autor): void {

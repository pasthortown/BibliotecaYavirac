...
@Component({
   selector: 'app-descargarecursodigital',
   templateUrl: './descargarecursodigital.component.html',
   styleUrls: ['./descargarecursodigital.component.scss']
})

export class DescargaRecursoDigitalComponent implements OnInit {

   busy: Promise<any>;
   entidades: DescargaRecursoDigital[];
   entidadSeleccionada: DescargaRecursoDigital;
   pagina: 1;
   tamanoPagina: 20;
   paginaActual: number;
   paginaUltima: number;
   ...
   constructor(public toastr: ToastsManager, vcr: ViewContainerRef, private dataService: DescargaRecursoDigitalService, private modalService: NgbModal) {
   ...
   isValid(entidadPorEvaluar: DescargaRecursoDigital): boolean {
      return true;
   }
   ...
   crearEntidad(): DescargaRecursoDigital {
      const nuevoDescargaRecursoDigital = new DescargaRecursoDigital();
      nuevoDescargaRecursoDigital.id = 0;
      return nuevoDescargaRecursoDigital;
   }

   add(entidadNueva: DescargaRecursoDigital): void {
   ...
   update(entidadParaActualizar: DescargaRecursoDigital): void {
   ...
   delete(entidadParaBorrar: DescargaRecursoDigital): void {
   ...
   refresh(): void {
      ...
      this.entidades = DescargaRecursoDigital[0];
      this.entidadSeleccionada = this.crearEntidad();
   }
   ...
   onSelect(entidadActual: DescargaRecursoDigital): void {
